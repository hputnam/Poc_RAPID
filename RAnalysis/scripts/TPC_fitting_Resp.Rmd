...
for(i in 1:nrow(d_fits)){
  ...
  temp_fit <- nls_multstart(rate~sharpeschoolhigh_1981(temp = temp, r_tref,e,eh,th, tref = 28),
                        data = temp_data,
                        iter = c(3,3,3,3),
                        start_lower = get_start_vals(temp_data$temp, temp_data$rate, model_name = 'sharpeschoolhigh_1981') - 1,
                        start_upper = get_start_vals(temp_data$temp, temp_data$rate, model_name = 'sharpeschoolhigh_1981') + 1,
                        lower = get_lower_lims(temp_data$temp, temp_data$rate, model_name = 'sharpeschoolhigh_1981'),
                        upper = get_upper_lims(temp_data$temp, temp_data$rate, model_name = 'sharpeschoolhigh_1981'),
                        supp_errors = 'Y',
                        convergence_count = FALSE)
