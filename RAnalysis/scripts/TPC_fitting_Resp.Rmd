...
```{r}
 #set plot colors
cols <- c("grandis"="darkgreen","meandrina"="orange",  "tuahiniensis"="purple",  "verrucosa.Dec"="pink")
...
TPC.plot <- ggplot(data=d, aes(x=temp)) +
   ...
   geom_point(aes(temp, transformed.rate, color="tuahiniensis"), d.tuahiniensis, size = 2, alpha = 0.5) +
