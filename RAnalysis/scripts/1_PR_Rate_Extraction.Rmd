...
pr.out %>% 
ggplot(aes(x=avg_temp_interval, y=Pc, color=Species, group=colony_id.x))+ 
  geom_point()+
  geom_line()+
  ylab("µmol O2 cm^2 s-1")+
  facet_wrap(~ Species*Light,  ncol = 5, scales = "free")+
...
ggplot(aes(x=avg_temp_interval, y=Pc, color=Species, group=colony_id.x))+ 
  ...
  geom_line()+
  ylab("µmol O2 cm^2 s-1")+
   facet_wrap(~ Light,  ncol = 5, scales = "free")
