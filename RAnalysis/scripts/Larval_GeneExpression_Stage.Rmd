...
#filter data to embryo and larval stage at 28°
TranscriptCountData <- TranscriptCountData[,c(1:5,7,9,11)]
#filter sample metadata to embryo and larval stage at 28°
...
pdf("figures/DEGS_Up_in_Larvae_vs_Emb_Enriched_GOTerms_semsim.pdf", width = 8, height = 8)
