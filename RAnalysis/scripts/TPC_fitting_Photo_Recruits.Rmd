...
```{r}
d <- data %>%
  filter(!colony_id.x == "REC-009") %>%
  filter(!colony_id.x == "REC-011") %>%
  filter(!colony_id.x == "REC-013") %>%
  filter(!colony_id.x == "REC-017") %>%
  filter(!colony_id.x == "REC-032") %>%
  filter(!colony_id.x == "REC-012") %>%
  filter(!colony_id.x == "REC-023") %>%
  filter(!colony_id.x == "REC-035") %>%
  filter(!colony_id.x == "REC-037")
